...
################################################################################
## Form generated from reading UI file '1AXESWc.ui'
##
## Created by: Qt User Interface Compiler version 5.14.2
##
## WARNING! All changes made in this file will be lost when recompiling UI file!
...
from PySide2.QtCore import (QCoreApplication, QDate, QDateTime, QMetaObject,
    QObject, QPoint, QRect, QSize, QTime, QUrl, Qt,QThread,Signal,QObject)
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ViewsEdit.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.KeywordEdit.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.viewsPlain.setText(QCoreApplication.translate("MainWindow", u"Views:", None))
        self.titleEdit.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.titlePlain.setText(QCoreApplication.translate("MainWindow", u"Title", None))
        self.PicEdit.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.result.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.FlieSelect.setText(QCoreApplication.translate("MainWindow", u"FlieSelect", None))
    ...
    def show(self):
        ...
        with open('./temp/'+url.split('v=')[-1]+'.jpg','wb') as f:
            f.write(req.content)
        self.PicEdit.setPixmap(QPixmap('./temp/'+url.split('v=')[-1]+'.jpg'))
        self.tableWidget.setRowCount(0)
        self.tableWidget.clear()
        self.tableWidget.setColumnCount(6)
        # self.tableWidget.setEditsetEditTriggers(QAbstractItemView.NoEditTriggers)
    ...
    def download(self):
        ...
        if yt==None:
            self.label.setText("请先获取视频信息")
            return
        if self.DownloadPath.toPlainText()=="":
            self.label.setText("请选择下载路径")
            return
        if self.tableWidget.currentRow()==-1:
            self.label.setText("请选择下载视频")
            return
